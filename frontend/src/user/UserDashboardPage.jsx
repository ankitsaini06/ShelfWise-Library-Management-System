...
import { userDashboardPageStyles as s } from "../dummyStyles";
...
<p className={s.heroText}>
  ...
  Student ID:{" "}
  {currentUserSummary?.studentId ?? "Not assigned"}
</div>
...
<div className={s.profileDetailItem}>
  ...
  <div className={s.semesterDetails}>
    <div className={s.semesterDetailItem}>
      Stream:{" "}
      {currentUserSummary?.stream ?? "General"}
    </div>
    ...
    return (
      ...
      >
        <div className={s.statHeader}>
          ...
          <span className={s.statLiveBadge}>
            Live
          </span>
        </div>
...
<section className={s.recentSection}>
  <div className={s.recentHeader}>
    ...
    <Link
      to="/user/books"
      className={s.viewMoreButton}>View More</Link>
  </div>
