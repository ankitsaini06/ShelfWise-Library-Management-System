...
import { loginStyles as s } from "../dummyStyles";
      ...
      <div className={s.mainCard}>
        ...
        <section className={s.infoPanel}>
          ...
          <p className={s.infoDescription}>
            Select the role you want to enter, then login with the
            matching account.
          </p>
          ...
          <div className={s.infoBoxesContainer}>
            <div className={s.infoBox}>
              ...
              <p className={s.infoBoxText}>
                Access your issued books, fines, profile
            ...
            <div className={s.infoBox}>
              ...
              <p className={s.infoBoxText}>
                Log in using your registered admin account to
                access the administrative dashboard and catalog
                features.
              </p>
            </div>
          </div>
        ...
        <section className={s.formPanel}>
          <div className={s.formInner}>
            ...
            <p className={s.formSubtitle}>
              Select your role and use your college library account
              credentials.
            </p>
